...
output_path = "/Users/cassandrabrigham/Documents/POSTDOC/Data analysis/Error/Code testing/Data/Ground A/DoDs/test_site_5a_FL_ground_dod_modified.tif"
...
with open(file_path, 'w') as file:
    ...
    file.write("\tArea\n")
    file.write(f"\t\t{len(vert_diff_array_dtm)}m^2\n")
    file.write("\tError\n")
